...
class RmVideo < Formula
  ...
  ENTRIES = %w[rm-video rm-studio rm-transcribe rm-voice rm-mux rm-library rm-demo rm-share rm-setup rm-compose rm-insert rm-align-audio rm-render-alignment rm-render-hyperframes rm-visual-beats rm-fal].freeze
