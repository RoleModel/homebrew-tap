...
class RmVideo < Formula
  ...
  sha256 "5108c8f273d05cd277dae9099744c26f4a293d4cc7f8b6edd1861fd93ce11d91"
  license "MIT"
  ...
  ENTRIES = %w[rm-video rm-studio rm-transcribe rm-voice rm-mux rm-library rm-demo rm-share rm-setup rm-compose rm-insert rm-align-audio rm-render-alignment rm-render-hyperframes rm-render-pip rm-adopt rm-resync rm-retime-pip rm-reconcile rm-visual-beats rm-fal].freeze
